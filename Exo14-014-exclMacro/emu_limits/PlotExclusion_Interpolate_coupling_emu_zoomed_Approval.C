{
  ...
  float exp[nm] = {0.270911, 0.229688, 0.278787, 0.771095, 0.147626, 0.133925, 0.0327043, 0.00959089, 0.00551888, 0.00407575, 0.00279852, 0.00222304, 0.00154023, 0.00146327, 0.00143876, 0.0016471};
 ...
 // CMS_lumi( c1, 2, 0 );
  ...
  frame->GetYaxis()->SetTitle("95% C.L. upper limit on #||{V_{eN}V*_{#muN}}");
  ...
  leg->AddEntry(graphs[11], "CL_{s} Expected  #pm 1#sigma", "f");
  leg->AddEntry(graphs[12], "CL_{s} Expected  #pm 2#sigma", "f");
  ...
  c1->Update();
  c1->RedrawAxis();
  c1->SaveAs("exclusion_em_zoom.pdf");
